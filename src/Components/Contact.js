...
const Contact = () => {
  ...
  return (
    ...
    <div id="contact" className=' w-full h-auto justify-start p-10 font-mono'><br/>
        <div className=' w-auto h-auto xl:flex bg-transparent border-2 border-teal-100 rounded-lg justify-around backdrop-blur-md opacity-95'>
        ...
        <div className=' border-2 flex xl:w-1/2 lg:w-full lg:flex  bg-teal-900 flex-col backdrop-blur-xl border-teal-900 rounded-xl justify-center p-2 text-sm text-mono xl:text-xl text-white tracking-wider text-start xl:space-y-5 '>
          ...
          <h1 className='text-center justify-center md:text-5xl text-3xl xl:text-5xl font-[youngr] font-bold lg:text-2xl text-teal-900 flex mt-3'>Contact</h1>
            ...
            <button type="submit" alt="submit" name="message" value="Send" className='bg-teal-900 border-2 xl:text-xl text-xl xl:p-2 xl:w-40 w-32 p-1 border-teal-200 text-white transition ease-in-out duration-300 rounded-full hover:text-black hover:border-teal-700 hover:bg-teal-100 hover:scale-105'>Submit</button>
          </form>
        </div>
        </div>
      </div>
